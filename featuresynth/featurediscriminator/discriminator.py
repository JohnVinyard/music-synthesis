...
class Discriminator(nn.Module):
    def __init__(self, frames, feature_channels, channels, n_judgements):
        ...
        self.spec = nn.Sequential(
            nn.Conv1d(feature_channels, channels, 3, 1, dilation=1, padding=1, bias=False),
            nn.Conv1d(channels, channels, 3, 1, dilation=3, padding=3, bias=False),
            nn.Conv1d(channels, channels, 3, 1, dilation=9, padding=9, bias=False),
            nn.Conv1d(channels, channels, 3, 1, dilation=27, padding=27, bias=False),
            nn.Conv1d(channels, channels, 3, 1, dilation=1, padding=1, bias=False),
            nn.Conv1d(channels, channels, 3, 1, dilation=1, padding=1, bias=False),
        )
        ...
        self.combo = nn.Sequential(
            nn.Conv1d(channels * 2, channels, 3, 1, dilation=1, padding=1, bias=False),
            nn.Conv1d(channels, channels, 3, 1, dilation=3, padding=3, bias=False),
            nn.Conv1d(channels, channels, 3, 1, dilation=9, padding=9, bias=False),
            nn.Conv1d(channels, channels, 3, 1, dilation=27, padding=27, bias=False),
            nn.Conv1d(channels, channels, 3, 1, dilation=1, padding=1, bias=False),
